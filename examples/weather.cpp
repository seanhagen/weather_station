 ...
 * atmospheric sensor - BME280, UV sensor - VEML6075, lightning detector -
 * AS3935, soil moisture sensor, wind and rain meters.
 *
 * Priyanka Makin @ SparkX Labs
 * Original Creation Date: August 20, 2020
 *
 * This code is Lemonadeware; if you see me (or any other SparkFun employee) at
 * the local, and you've found our code helpful, please buy us a round!
 *
 * Hardware Connections:
 * Insert MicroMod processor board of your choice into the M.2 connector of the
 * SparkFun Weather carrier Screw into place Connect Weather carrier board to
 * power useing USB-C cable Connect SparkFun Soil Moisture Sensor to Weather
 * carrier using latching terminals Connect both wind and rain meters to Weather
 * carrier using the RJ11 connectors
 */
...
const int soilPin = A0;   // Pin number that measures analog moisture signal
const int soilPower = G0; // Pin number that will power the soil moisture sensor
const int WSPEED = D0;    // Digital I/O pin for wind speed
const int WDIR = A1;      // Analog pin for wind direction
const int RAIN = D1;      // Digital I/O pin for rain fall
...
void loop() {
  ...
  // Serial.println(String(uv.uva()) + ", " + String(uv.uvb()) + ", " +
  //                String(uv.index()));
